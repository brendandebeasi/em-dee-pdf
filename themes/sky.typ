...
// =============================================================================
// COLOR PALETTE - Tailwind Sky
// =============================================================================
#let primary = rgb("#0284c7")         // Sky 600
#let primary-dark = rgb("#0369a1")    // Sky 700
#let secondary = rgb("#0ea5e9")       // Sky 500
#let text-primary = rgb("#0c4a6e")    // Sky 900
#let text-secondary = rgb("#075985")  // Sky 800
#let text-muted = rgb("#7dd3fc")      // Sky 300

#let background = rgb("#f0f9ff")      // Sky 50
#let surface = rgb("#e0f2fe")         // Sky 100
#let surface-alt = rgb("#bae6fd")     // Sky 200
#let border = rgb("#7dd3fc")          // Sky 300

#let code-bg = rgb("#0c4a6e")         // Sky 900 - Dark code
#let code-text = rgb("#e0f2fe")       // Sky 100
