...
// H2 creates full-width panel header
#show heading.where(level: 2): it => {
  ...
  block(
    fill: surface,
    stroke: (left: 1pt + border, right: 1pt + border, bottom: 1pt + border),
    inset: (x: 20pt, top: 14pt, bottom: 8pt),
    radius: (bottom: 6pt),
    width: 100%,
    above: 0em,
    below: 0.8em,
...
#show table: it => block(above: 1em, below: 1.2em, breakable: false, it)
