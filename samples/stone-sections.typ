...
// =============================================================================
#let primary = rgb("#57534e")         // Stone 600
#let primary-dark = rgb("#44403c")    // Stone 700
#let secondary = rgb("#78716c")       // Stone 500
#let text-primary = rgb("#0c0a09")    // Stone 950
#let text-secondary = rgb("#1c1917")  // Stone 900
#let text-muted = rgb("#d6d3d1")      // Stone 300

#let background = rgb("#fafaf9")      // Stone 50
#let surface = rgb("#f5f5f4")         // Stone 100
#let surface-alt = rgb("#e7e5e4")     // Stone 200
#let border = rgb("#d6d3d1")          // Stone 300

#let code-bg = rgb("#1c1917")         // Stone 900 - Dark code
#let code-text = rgb("#f5f5f4")       // Stone 100
