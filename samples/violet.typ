...
// =============================================================================
// COLOR PALETTE - Tailwind Violet
// =============================================================================
#let primary = rgb("#7c3aed")         // Violet 600
#let primary-dark = rgb("#6d28d9")    // Violet 700
#let secondary = rgb("#8b5cf6")       // Violet 500
#let text-primary = rgb("#2e1065")    // Violet 950
#let text-secondary = rgb("#4c1d95")  // Violet 900
#let text-muted = rgb("#c4b5fd")      // Violet 300

#let background = rgb("#f5f3ff")      // Violet 50
#let surface = rgb("#ede9fe")         // Violet 100
#let surface-alt = rgb("#ddd6fe")     // Violet 200
#let border = rgb("#c4b5fd")          // Violet 300

#let code-bg = rgb("#2e1065")         // Violet 950 - Dark code
#let code-text = rgb("#ede9fe")       // Violet 100
