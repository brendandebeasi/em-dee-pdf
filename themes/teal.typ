...
// =============================================================================
// COLOR PALETTE - Tailwind Teal
// =============================================================================
#let primary = rgb("#0d9488")         // Teal 600
#let primary-dark = rgb("#0f766e")    // Teal 700
#let secondary = rgb("#14b8a6")       // Teal 500
#let text-primary = rgb("#042f2e")    // Teal 950
#let text-secondary = rgb("#134e4a")  // Teal 800
#let text-muted = rgb("#5eead4")      // Teal 300

#let background = rgb("#f0fdfa")      // Teal 50
#let surface = rgb("#ccfbf1")         // Teal 100
#let surface-alt = rgb("#99f6e4")     // Teal 200
#let border = rgb("#5eead4")          // Teal 300

#let code-bg = rgb("#042f2e")         // Teal 950 - Dark code
#let code-text = rgb("#ccfbf1")       // Teal 100
